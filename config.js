...
var globalAccountSettings = [{
        href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/MasterInfo/',
    ...
    {
        href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/DAC/',
        hrefLabel: 'Master DAC',
        forceReadOnly: true,
        settingsAccount: true,
        checkContentType: true,
        userAuth: {
...
var globalSubscribedCalendars = {
    ...
    calendars: [{
        ...
        href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/IMA/M2_IMA/',
        userAuth: {
            userName: 'student.master',
            userPassword: 'guest'
        },
